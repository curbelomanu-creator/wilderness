// Wilderness 4.3.2 - single main warrior model, forward-held sword and staff
(()=>{
...
// Remove every inherited visible mesh from the protagonist. Keep only transform groups used by animation.
...
// Rebuild the limbs once inside the legacy animation pivots.
...
const sword=new T.Group();sword.name='hero43-sword';hand.add(sword);sword.position.set(.02,-1.10,.09);
// +X rotation makes the blade project toward local +Z, i.e. the direction the character faces.
sword.rotation.set(1.08,0,-.10);
